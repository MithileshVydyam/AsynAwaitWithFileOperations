...
function fileOperation() {
    return __awaiter(this, void 0, void 0, function () {
        var fileContent1, data, fileContent2, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    fileContent1 = readPromise('./filePromiseAsync.txt');
                    console.log("after fileContent1 ");
                    console.log(fileContent1);
                    console.log("1");
                    console.log("2");
                    console.log("3");
                    return [4 /*yield*/, fileContent1];
                case 1:
                    data = _a.sent();
                    console.log(data);
                    return [4 /*yield*/, writeFilePromise("./filePromiseAsync.txt", "Loreum ipsum dollar sit.")];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, readPromise('./filePromiseAsync.txt')];
                case 3:
                    fileContent2 = _a.sent();
